...
const demoTemplates: DemoTemplate[] = [
  ...
  },
  {
    ...
    revisions: [
      { id: "hero-motion", label: "切换安静展示", prompt: "持续运动容易分散注意力，请把页面切换为更安静的展示模式，并让内容成为视觉中心。", response: "我会停止背景和品牌轨道的循环动画，弱化背景图形并固定浮动导航，只保留首次进入时的内容动画。" },
    ...
    takeaways: ["专业提示词应同时说明结构、技术栈和体验边界", "动态效果应帮助用户理解信息层级，并控制与内容无关的运动", "性能、移动端和减少动态效果规则应在生成前提出"],
  },
];
