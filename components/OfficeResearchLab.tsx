...
export function OfficeResearchLab() {
  ...
  return (
    <section className="office-research-lab" aria-labelledby="office-lab-title">
      <header className="office-lab-heading"><div><span>差异化交付演示 · 非实时 AI</span><h3 id="office-lab-title">从资料输入，到可复核的办公成果</h3><p>三个模板分别演示文件交付、对话内纪要和表格前后对照，不读取真实文件。</p></div><b>{progress}%</b></header>
