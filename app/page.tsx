    ...
    <main className="site-shell">
      ...
      <section className="hero" id="top">
        ...
        <div className="starter-panel" role="group" aria-label="新手入口">
          ...
          <BrowserNavigationLink className="starter-card violet advanced-entry" href="/advanced"><span className="starter-icon" aria-hidden="true">↗</span><span className="starter-content"><strong>工具已经安装好了？</strong><small>从一个真实的小目标开始，尝试内容创作、应用构建、办公研究或 Agent 自动化。</small><span className="starter-action">试试进阶路线</span></span><span className="starter-index">03</span><span className="arrow" aria-hidden="true">→</span></BrowserNavigationLink>
        </div>
      </section>
