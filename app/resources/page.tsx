...
import { aiWebServices, apiPlatforms, featuredResources, networkCheckServices, platformClients } from "@/data/resources";
...
export default function ResourcesPage() {
  return (
    <main className="site-shell detail-shell resources-page" id="top">
      <SiteHeader activePage="resources" />

      <section className="resource-hero resources-directory-hero">
        <div className="resources-hero-copy">
          <span className="eyebrow">可信入口 · 简明说明</span>
          <h1>常用资源集中找，<br />少在陌生页面里绕路</h1>
          <p>这里不做复杂排行榜，只整理适合 AI 入门、创作、设计、开发与学习的官方入口。访问前请核对页面显示的域名。</p>
        </div>
        <nav className="resource-hero-map" aria-label="资源分类快速跳转">
          <strong>本页资源地图</strong>
          <a href="#platform-clients"><span>平台代理客户端</span><small>{platformClients.length} 个入口</small><b aria-hidden="true">↘</b></a>
          <a href="#network-checks"><span>网络环境检测</span><small>{networkCheckServices.length} 个入口</small><b aria-hidden="true">↘</b></a>
          <a href="#ai-services"><span>AI 官方对话</span><small>{aiWebServices.length} 个入口</small><b aria-hidden="true">↘</b></a>
          <a href="#api-platforms"><span>API 开放平台</span><small>{apiPlatforms.length} 个入口</small><b aria-hidden="true">↘</b></a>
          <a href="#featured-sites"><span>精选网站</span><small>{featuredResources.length} 个入口</small><b aria-hidden="true">↘</b></a>
          <a href="#github-projects"><span>GitHub 项目</span><small>{githubProjects.length} 个项目</small><b aria-hidden="true">↘</b></a>
        </nav>
      </section>
